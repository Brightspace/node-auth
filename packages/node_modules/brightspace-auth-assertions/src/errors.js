class InvalidContextError extends Error {
	constructor(required, configured, actual) {
		let msg = `Invalid context. "${actual}" context is not allowed.`;

		if (required) {
			msg += ` Expected "${configured}"`;
		}
...
export {
	InvalidContextError as InvalidContext,
	InsufficientScopeError as InsufficientScope,
	ImpersonationNotAllowedError as ImpersonationNotAllowed,
	ImpersonationRequiredError as ImpersonationRequired
};

...
import AbstractPublicKeyStore from './abstract-public-key-store.js';
import clock from './clock.js';
import ecKeygen, { normalize as ecNormalize } from './ec-key-generator.js';
import rsaKeygen, { normalize as rsaNormalize } from './rsa-key-generator.js';
	...
	constructor(opts) {
		...
		switch (opts.signingKeyType) {
			case SIGNING_KEY_TYPE_RSA: {
				this.keygen = rsaKeygen.bind(null, rsaNormalize(opts.rsa));
				break;
			}
			case SIGNING_KEY_TYPE_EC: {
				this.keygen = ecKeygen.bind(null, ecNormalize(opts.ec));
				break;
			}
			default: {
...
export default CoreKeyGenerator;

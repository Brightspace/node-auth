...
import { decodeProtectedHeader, decodeJwt, compactVerify } from 'jose';
...
const USER_AGENT = 'node-auth/brightspace-auth-validation/' + __pkg.version;
...
async function verifySignature(signature, token, publicKey) {
	...
	try {
		await compactVerify(signature, publicKey.key, { algorithms: [alg] });
	} catch (e) {

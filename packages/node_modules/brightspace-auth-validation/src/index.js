...
const jose = {
	decodeHeader: require('jose/decode/protected_header').decodeProtectedHeader,
	decodePayload: require('jose/jwt/decode').decodeJwt,
	verify: require('jose/jws/compact/verify').compactVerify,
};

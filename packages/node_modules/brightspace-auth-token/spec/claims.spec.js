...
import BrightspaceAuthToken from '../src/index.js';
...
describe('Claims', function() {
	...
	describe('authorizedParty', function() {
		it('should expose "azp"', function() {
			const token = new BrightspaceAuthToken({
				azp: 'expandoFooClient'
			}, 'x.y.z');

			expect(token.azp).to.equal('expandoFooClient');
		});

		it('should be "undefined" when there is no "azp"', function() {
			const token = new BrightspaceAuthToken({}, 'x.y.z');

			expect(token.azp).to.be.undefined;
		});
	});
});
